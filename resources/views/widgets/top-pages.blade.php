<x-filament-widgets::widget>
    <x-filament::section :heading="__('filament-metrics-fathom::metrics-fathom.widgets.top_pages.label')">
        @if (! $configured)
                    ...
                    <thead>
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            <th class="pb-2 text-left font-medium text-gray-500 dark:text-gray-400">
                                {{ __('filament-metrics-fathom::metrics-fathom.widgets.top_pages.page') }}
                            </th>
                            <th class="pb-2 text-right font-medium text-gray-500 dark:text-gray-400">
                                {{ __('filament-metrics-fathom::metrics-fathom.widgets.top_pages.visits') }}
                            </th>
                            <th class="pb-2 text-right font-medium text-gray-500 dark:text-gray-400">
                                {{ __('filament-metrics-fathom::metrics-fathom.widgets.top_pages.pageviews') }}
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($data as $row)
                            <tr class="border-b border-gray-100 dark:border-gray-800">
                                <td class="py-2 text-gray-900 dark:text-gray-100 truncate max-w-[200px]" title="{{ $row['pathname'] ?? '-' }}">
                                    {{ $row['pathname'] ?? '-' }}
                                </td>
